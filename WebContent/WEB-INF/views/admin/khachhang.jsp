            ...
            <div style="float: right; margin-left: 300px !important;">
                <div style="margin-left: 300px;">
                    <div class="container">
                            ...
                            <div class="modal-dialog modal-sm">
                                <div class="modal-content" style="width: 500px !important; height: 400px !important;">
                                    ...
                                    <div class="modal-body" style="width: 500px !important; height: 520px !important;">
                                        <form:form action="akhachhang.htm" modelAttribute="khachhang" onsubmit="return validate()" method="post">
                                            <div class="row no-gutters mb-2" style="margin-left: 40px;">
                                                <div style="color: red;" class="col-4 d-flex align-items-center">
                                                    <p class="font-weight-normal">Họ khách hàng:</p>
                                                </div>
                                                <div class="col-8 pb-2 d-flex align-items-center">
                                                    <h6 class="text-dark">
                                                        <form:input path="ho" id="num1" style="width: 200px;" class="form-control" autocomplete="off" title="vui lòng nhập họ " />
                                                    </h6>
                                                </div>
                                            </div>
                                            <div class="row no-gutters mb-2" style="margin-left: 40px;">
                                                <div style="color: red;" class="col-4 d-flex align-items-center">
                                                    <p class="font-weight-normal">Tên khách hàng:</p>
                                                </div>
                                                <div class="col-8 pb-2 d-flex align-items-center">
                                                    <h6 class="text-dark">
                                                        <form:input path="ten" id="num2" style="width: 200px;" class="form-control" autocomplete="off" title="vui lòng nhập tên" />
                                                    </h6>
                                                </div>
                                            </div>
                                            ...
                                            <div class="row no-gutters mb-2" style="margin-left: 40px;">
                                                <div style="color: red;" class="col-4 d-flex align-items-center">
                                                    <p class="font-weight-normal">Địa Chỉ:</p>
                                                </div>
                                                <div class="col-8 pb-2 d-flex align-items-center">
                                                    <h6 class="text-dark">
                                                        <form:input path="diachi" id="num3" style="width: 200px;" class="form-control" autocomplete="off" />
                                                    </h6>
                                                </div>
                                            </div>
                                            <div class="row no-gutters mb-2" style="margin-left: 40px;">
                                                <div style="color: red;" class="col-4 d-flex align-items-center">
                                                    <p class="font-weight-normal">Số Điện Thoại:</p>
                                                </div>
                                                <div class="col-8 pb-2 d-flex align-items-center">
                                                    <h6 class="text-dark">
                                                        <form:input
                                            ...
                                            <div class="modal-footer">
                                                ...
                                                <button name="${btnStatus}" id="dismiss-popup-btn " type="submit" class="btn btn-default 2" style="background-color: blue; color: black; opacity: 0.9;">Thêm</button>
                                            </div>
                                        </form:form>
                                    </div>
                                </div>
                        ...
                        <!-- Modal edit khachhang-->

                        <div class="modal fade" id="myModal" role="dialog">
                            <div class="modal-dialog modal-sm">
                                <div class="modal-content" style="width: 500px !important; height: 500px !important;">
                                    <div class="modal-header">
                                        <h4 class="modal-title" style="color: red;">Thay đổi thông tin khách hàng</h4>
                                        <button type="button" class="close" data-dismiss="modal" style="float: right !important;">&times;</button>
                                    </div>
                                    <div class="modal-body" style="width: 500px !important; height: 520px !important;">
                                        <form:form action="/Lab_2/akhachhang.htm" modelAttribute="khachhang" onsubmit="return validate()" method="post">
                                            <div class="row no-gutters mb-2" style="margin-left: 40px;">
                                                <div style="color: red;" class="col-4 d-flex align-items-center">
                                            ...
                                            <div class="row no-gutters mb-2" style="margin-left: 40px;">
                                                ...
                                                <div class="col-8 pb-2 d-flex align-items-center">
                                                    <h6 class="text-dark">
                                                        <form:input path="ho" id="num6" style="width: 200px;" class="form-control" autocomplete="off" />
                                                    </h6>
                                                </div>
                                            </div>
                                            <div class="row no-gutters mb-2" style="margin-left: 40px;">
                                                ...
                                                <div class="col-8 pb-2 d-flex align-items-center">
                                                    <h6 class="text-dark">
                                                        <form:input path="ten" id="num7" style="width: 200px;" class="form-control" autocomplete="off" />
                                                    </h6>
                                                </div>
                                            </div>
                                            ...
                                            <div class="row no-gutters mb-2" style="margin-left: 40px;">
                                                ...
                                                <div class="col-8 pb-2 d-flex align-items-center">
                                                    <h6 class="text-dark">
                                                        <form:input path="diachi" id="num8" style="width: 200px;" class="form-control" autocomplete="off" />
                                                    </h6>
                                                </div>
                                            </div>
                                            <div class="row no-gutters mb-2" style="margin-left: 40px;">
 				...
 				<input id="myInput" onkeyup="myFunction()" type="text" placeholder="    Search...........&#160; &#160; &#160; &#160; &#160; &#160; &#160; &#160; &#160; &#160; &#160; &#160; &#160; &#9997;" class="form-control tickets-code" autocomplete="off" style="width: 400px;margin-bottom: 5px; ">
                    ...
                    <table class="table table-hover" style="margin-right: 400px;">
                        <tr style="background-color: pink;">
                            <th style="text-align: center;">ID khachhang</th>
                        ...
                        <c:forEach var="k" items="${akhachhang}">
                        <tbody id="myTable">
                            <tr>
                                <td style="text-align: center;">${k.id}</td>
                                <td style="text-align: center;">${k.ho}</td>
                                <td style="text-align: center;">${k.ten}</td>
                                ...
                                <td>
                                    <button class="btn btn-success" type="button" class="btnedit" data-toggle="modal" data-target="#myModal" style="border: none; ">
                                        <a style="color: white !important;text-decoration: none;" href="/Lab_2/akhachhang/${k.id}-${k.ho}-${k.ten}-${k.diachi}-${k.sdt}.htm?linkEdit">Edit</a>
                                        <a href="javascript:void(0)"><i style="color: white !important; width: 50px; height: 40px;" disabled="disabled" class="fas fa-pen-alt"> </i></a>
                                    </button>
                                </td>

                                <td>
                                    <a onclick="huy()" style="text-decoration: none; margin-bottom: 10px;" class="btn btn-danger"  name="btnDelete" href="/Lab_2/akhachhang/${k.id}.htm?linkDelete" role="button" id="dismiss-popup-btn">
                ...
                <aside class="left-sidebar" data-sidebarbg="skin6" style="position: fixed; top: 100px !important; width: 300px; margin-left: -20px;">
                    <nav class="sidebar-nav">
                        <ul id="sidebarnav" class="col-md-3">
                            <li class="sidebar-item pt-2 hoc" style="border-left: thick solid #ff0000; background-color: #e3e3e3;">
        ...
        $(document).ready(function(){
            ...
            function validate() {
                ...
                if (n1.value != "" && n2.value != "" && n3.value != "" && n4.value != "") {
                    ...
                    if (n1.value == "" && n6.value == "") {
                        alert("Vui lòng nhập họ người đi!!!");
                        return false;
                    }
                    if (n2.value == "" && n7.value == "") {
                        alert("Vui lòng nhập tên người đi!!!");
                        return false;
                    }
                    if (n3.value == "" && n8.value == "") {
                        alert("Vui lòng nhập địa chỉ người đi!!!");
                        return false;
                    }
                    if (n4.value == "" && n9.value == "") {
                        alert("Vui lòng nhập số điện thoại người đi!!!");
                        return false;
                    }
                }
            }

    ...
    <body>
        ...
        <div id="main-wrapper" data-layout="vertical" data-navbarbg="skin5" data-sidebartype="full" data-sidebar-position="absolute" data-header-position="absolute" data-boxed-layout="full">
            ...
            <div style="float: right; margin-left: 300px !important;">
				...
				<div class="container" >
				<div class="row" style="margin-left: 200px;margin-top: 80px;">
				<div class="col-sm-3" style="width: 200px;height: 200px;background-color:green;background-image: linear-gradient(0deg, green, gray);margin-bottom:50px;border-radius: 10px;">
					<div style="margin-top: 40px;text-align: center;color:white;">
					<p style="font-weight: bold;font-size: 20px;">Khách Hàng</p>
					<p>Tổng số khách</p>
					<p>${requestScope.khachhang}</p>
					</div>
				</div>
				<div class="col-sm-3" style="width: 200px;height: 200px;background-color:blue;background-image: linear-gradient(0deg, blue, gray);margin-left: 100px;border-radius: 10px;">
					<div style="margin-top: 40px;text-align: center;color:white;">
					<p style="font-weight: bold;font-size: 20px;">Chuyến Xe</p>
					<p>Tổng số chuyến</p>
					<p>${requestScope.chuyen}</p>
					</div>
				</div>
				<div class="col-sm-3" style="width: 200px;height: 200px;background-color:red;background-image: linear-gradient(0deg, red, gray);margin-left: 100px;border-radius: 10px;">
					<div style="margin-top: 40px;text-align: center;color:white;">
					<p style="font-weight: bold;font-size: 20px;">Tuyến Xe</p>
					<p>Tổng số tuyến</p>
					<p>${requestScope.tuyen}</p>
					</div>
				</div>
				</div>
				<div class="row" style="margin-left: 200px;">
					<div class="col-sm-3" style="width: 200px;height: 200px;background-color:pink;background-image: linear-gradient(0deg, pink, gray);border-radius: 10px;">
					<div style="margin-top: 40px;text-align: center;color:white;">
					<p style="font-weight: bold;font-size: 20px;">Xe</p>
					<p>Tổng số xe</p>
					<p>${requestScope.xe}</p>
					</div>
					</div>
					<div class="col-sm-3" style="width: 200px;height: 200px;background-color:yellow;background-image: linear-gradient(0deg, yellow, gray); margin-left: 100px;border-radius: 10px;">
					<div style="margin-top: 40px;text-align: center;color:white;">
					<p style="font-weight: bold;font-size: 20px;">Vé Xe</p>
					<p>Tổng số vé xe</p>
					<p>${requestScope.ve}</p>
					</div>
					</div>
					<div class="col-sm-3" style="width: 200px;height: 200px;background-color:black;background-image: linear-gradient(0deg, black, gray);margin-left: 100px;border-radius: 10px;">
					<div style="margin-top: 40px;text-align: center;color:white;">
					<p style="font-weight: bold;font-size: 20px;">Loại Xe</p>
					<p>Tổng số loại</p>
					<p>${requestScope.loai}</p>
					</div>
					</div>
                ...
                <aside class="left-sidebar" data-sidebarbg="skin6" style="position: fixed; top: 100px !important; width: 300px;left: 19px;">

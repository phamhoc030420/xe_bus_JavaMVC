    ...
    <body>
            ...
            <div style="float: right; margin-left: 300px !important;">
                <div style="margin-left: 300px;">
                    <div class="container">
                            ...
                            <div class="modal-dialog modal-sm">
                                <div class="modal-content" style="width: 500px !important; height: 400px !important;">
                                    <div class="modal-header">
                                        <h4 class="modal-title" style="color: red;">Thêm Vé Xe</h4>
                                    ...
                                    <div class="modal-body" style="width: 500px !important; height: 520px !important;">
                                        <form:form action="ave.htm" modelAttribute="ve" onsubmit="return validate()" method="post">
                                            ...
                                            <div class="row no-gutters mb-2" style="margin-left: 40px;">
                                                <div style="color: red;" class="col-4 d-flex align-items-center">
                                                    <p class="font-weight-normal">Vị trí:</p>
                                                </div>
                                                <div class="col-8 pb-2 d-flex align-items-center">
                                                    <h6 class="text-dark">
                                                        <form:input
                                            ...
                                            <div class="modal-footer">
                                                ...
                                                <button name="${btnStatus}" id="dismiss-popup-btn " type="submit" class="btn btn-default 2" style="background-color: blue; color: black; opacity: 0.9;">Thêm Vé</button>
                                            	<%-- <button name="${btnStatus}" id="dismiss-popup-btn " type="submit" class="btn btn-default 2" style="background-color: blue; color: black; opacity: 0.9;"><a style="text-decoration: none;" href="/Lab_2/ave/num1.htm">Thêm Vé</a></button>
                                            	 --%>
                                            </div>
                                        </form:form>
                                    </div>
                        ...
                        <div class="modal fade" id="myModal" role="dialog">
                            <div class="modal-dialog modal-sm">
                                <div class="modal-content" style="width: 500px !important; height: 400px !important;">
                                    <div class="modal-header">
                                        <h4 class="modal-title" style="color: red;">Thay đổi thông tin vé</h4>
                                        <button type="button" class="close" data-dismiss="modal" style="float: right !important;">&times;</button>
                                    </div>
                                    <div class="modal-body" style="width: 500px !important; height: 520px !important;">
                                        <form:form action="/Lab_2/ave.htm" modelAttribute="ve" onsubmit="return validate()" method="post">
                                            <div class="row no-gutters mb-2" style="margin-left: 40px;">
                                                <div style="color: red;" class="col-4 d-flex align-items-center">
                                                    <p class="font-weight-normal">Mã Vé:</p>
                                                </div>
                                                <div class="col-8 pb-2 d-flex align-items-center">
                                                    <h6 class="text-dark">
                                                        <form:input
                    ...
                    <table class="table table-hover" style="margin-right: 600px;">
                        ...
                        <c:forEach var="v" items="${ave}">
                        <tbody id="myTable">
                            <tr style="margin-top: 20px;">
                                <td style="text-align: center;">${v.id}</td>
                                <td style="text-align: center;">${v.khachhang.ho} ${v.khachhang.ten}</td>
                                ...
                                <td>
                                    <button class="btn btn-success" type="button" class="btnedit" data-toggle="modal" data-target="#myModal" style="border: none;">
                                        <a style="color: white !important;text-decoration: none;" href="/Lab_2/ave/${v.id}-${v.khachhang.id}-${v.chuyen.id}-${v.vitri}.htm?linkEdit">Edit</a>
                                        <a href="javascript:void(0)"><i style="color: white !important;width: 50px; height: 40px;" disabled="disabled" class="fas fa-pen-alt"> </i></a>
                                    </button>
                                </td>

                                <td>
                                    <a onclick="huy()" class="btn btn-danger" style="text-decoration: none; margin-bottom: 10px;" name="btnDelete" href="/Lab_2/ave/${v.id}.htm?linkDelete" role="button" id="dismiss-popup-btn">
        ...
        $(document).ready(function(){
            ...
            function validate() {
                ...
                if (n1.value != "0" && n2.value != "0" && n3.value != "0" && n4.value != "0" && n5.value != "0" && n6.value != "0") {
                    alert("Thành Công!!!");
                    return true;
                } else {

    ...
    <body>
            ...
            <div style="float: right; margin-left: 300px !important;">
                <div style="margin-left: 300px;">
                            ...
                            <div class="modal-dialog modal-sm">
                                <div class="modal-content" style="width: 500px !important; height: 400px !important;">
                                    <div class="modal-header">
                                        <h4 class="modal-title" style="color: red;">Thêm Xe</h4>
                                    ...
                                    <div class="modal-body" style="width: 500px !important; height: 520px !important;">
                                        <form:form action="axe.htm" modelAttribute="xe" onsubmit="return validate()" method="post">
                                            <div class="row no-gutters mb-2" style="margin-left: 40px;">
                                                <div style="color: red;" class="col-4 d-flex align-items-center">
                                                    <p class="font-weight-normal">Số ghế:</p>
                                                </div>
                                                ...
                                                <div class="col-8 pb-2 d-flex align-items-center">
                                                    <h6 class="text-dark">
                                                        <form:input
                                                            ...
                                                            maxlength="11"
                                                            autocomplete="off"
                                                            onkeypress="return (event.charCode !=8 && event.charCode ==0 || (event.charCode >= 48 && event.charCode <= 49))"/>
                                                    </h6>
                                                </div>
                                                <p style="margin-left: 300px;">1.Trống 0.Đầy</p>
                                            </div>
                                            ...
                                            <div class="modal-footer">
                                                ...
                                                <button name="${btnStatus}" id="dismiss-popup-btn " type="submit" class="btn btn-default 2" style="background-color: blue; color: black; opacity: 0.9;">Thêm Xe</button>
                                            </div>
                                        </form:form>
                                    </div>
                                </div>
                        ...
                        <div class="modal fade" id="myModal" role="dialog">
                            <div class="modal-dialog modal-sm">
                                <div class="modal-content" style="width: 500px !important; height: 500px !important;">
                                    <div class="modal-header">
                                        <h4 class="modal-title" style="color: red;">Thay đổi Xe</h4>
                                        <button type="button" class="close" data-dismiss="modal" style="float: right !important;">&times;</button>
                                    </div>
                                    <div class="modal-body" style="width: 500px !important; height: 520px !important;">
                                        <form:form action="/Lab_2/axe.htm" modelAttribute="xe" onsubmit="return validate()" method="post">
                                            <div class="row no-gutters mb-2" style="margin-left: 40px;">
                                                <div style="color: red;" class="col-4 d-flex align-items-center">
                    ...
                    <table class="table table-hover" style="margin-right: 600px;">
                        ...
                        <c:forEach var="x" items="${axe}">
                        <tbody id="myTable">
                            <tr>
                                <td style="text-align: center;">${x.id}</td>
                                <td style="text-align: center;">${x.soghe}</td>
                                <td style="text-align: center;">${x.loai.ten}</td>
                                <td style="text-align: center;">${x.trangthai?'Trống':'Đầy'}</td>
                                <td>
                                    <button class="btn btn-success" type="button" class="btnedit" data-toggle="modal" data-target="#myModal" style="border: none;">
                                        <a style="color: white !important;text-decoration: none;" href="/Lab_2/axe/${x.id}-${x.soghe}-${x.loai.id}-${x.trangthai}.htm?linkEdit">Edit</a>
                                        <a href="javascript:void(0)"><i style= "color: white !important;width: 50px; height: 40px;" disabled="disabled" class="fas fa-pen-alt"> </i></a>
                                    </button>
                                </td>
                                <td>
                                    <a onclick="huy()" class="btn btn-danger" style="text-decoration: none; margin-bottom: 10px;" name="btnDelete" href="/Lab_2/axe/${x.id}.htm?linkDelete" role="button" id="dismiss-popup-btn">
        ...
        $(document).ready(function(){
            ...
            function validate() {
                ...
                if (n1.value != "0" && n2.value != "0" && n3.value != "" && n4.value != "0" && n5.value != "0" && n6.value != "") {
                    alert("Thành Công!!!");
                    return true;
                } else {
                    if (n1.value == "0" && n4.value == "0") {
                        alert("Vui lòng nhập số ghế!!!");
                        return false;
                    }
                    if (n2.value == "0" && n5.value == "0") {

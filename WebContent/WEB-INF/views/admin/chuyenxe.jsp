...
<html lang="en">
   <head>
      ...
      <style>
         ...
         background: #fff; }
         .scroll-sidebar{height:calc(100% - 20px);position:relative}
         .scroll-sidebar {
         ...
         display: block; }
         .table-hover:hover .btnedit{background-color: #E3E3E3 !important;}
         .btnedit:hover{background-color: #E3E3E3 !important;}
         /*  thong bao*/
         .center {
         position:absolute;
         top:50%;
      ...
      <div id="main-wrapper" data-layout="vertical" data-navbarbg="skin5" data-sidebartype="full"
         ...
         <header class="topbar" data-navbarbg="skin5">
            <nav class="navbar top-navbar navbar-expand-md navbar-dark" >
               ...
               <div style=" position: fixed;top:0px;left:270px;width:100%;height:60px !important;background-color: #383743;background-image: linear-gradient(to bottom right, #383743, pink); opacity: 0.8; height: 80px;" class="navbar-collapse collapse" id="navbarSupportedContent" data-navbarbg="skin5">
            ...
            <div style="margin-left: 300px ;" >
               <div class="container">
                  ...
                  <div class="modal fade" id="myModal1" role="dialog"  >
                     <div class="modal-dialog modal-sm" >
                        <div class="modal-content" style="width: 500px !important; height: 400px !important;"	>
                           <div class="modal-header" >
                              <h4 class="modal-title" style="color: red;">Thêm Chuyến Xe</h4>
                           ...
                           <div class="modal-body" style="width: 500px !important; height: 520px !important;">
                              <form:form action="achuyen.htm" modelAttribute="chuyen" onsubmit="return validate()" method="post">
                                 <div class="row no-gutters mb-2" style="margin-left: 40px;">
                                    ...
                                    <div class="col-8 pb-2 d-flex align-items-center">
                                       <h6 class="text-dark">
                                          <form:input path="tuyen.id"  id="num1" type="text" style="width: 200px;" class="form-control" maxlength="11" 
                                             autocomplete="off" onkeypress="return (event.charCode !=8 && event.charCode ==0 || (event.charCode >= 48 && event.charCode <= 57))"
                                             />
                                       </h6>
                                    </div>
                                 </div>
                                 <div class="row no-gutters mb-2" style="margin-left: 40px;">
                                    <div style="color: red;" class="col-4 d-flex align-items-center">
                                       <p class="font-weight-normal">Mã Xe:</p>
                                    </div>
                                    <div class="col-8 pb-2 d-flex align-items-center">
                                       <h6 class="text-dark">
                                          <form:input path="xe.id" id="num2" style="width: 200px;"  class="form-control" maxlength="11" autocomplete="off" onkeypress="return (event.charCode !=8 && event.charCode ==0 || (event.charCode >= 48 && event.charCode <= 57))" />
                                       </h6>
                                    </div>
                                 </div>
                                 <div class="row no-gutters mb-2" style="margin-left: 40px;">
                                    <div style="color: red;" class="col-4 d-flex align-items-center">
                                       <p class="font-weight-normal">Ngày:</p>
                                    </div>
                                    <div class="col-8 pb-2 d-flex align-items-center">
                                       <h6 class="text-dark">
                                          <form:input path="ngay" id="num3" name="ngay" type="date" min="2021-06-03"  style="width: 200px;"  class="form-control " autocomplete="off" />
                                       </h6>
                                    </div>
                                 </div>
                                 <div class="modal-footer">
                                    ...
                                    <button name="${btnStatus}" id="dismiss-popup-btn " type="submit" class="btn btn-default 2" style="background-color: blue; color: black; opacity: 0.9">Thêm
                                    </button>
                                 </div>
                              </form:form>
                           </div>
                  ...
                  <div class="modal fade" id="myModal" role="dialog"  >
                     <div class="modal-dialog modal-sm" >
                        <div class="modal-content" style="width: 500px !important; height: 500px !important;"	>
                           <div class="modal-header" >
                              <h4 class="modal-title" style="color: red;">Thay đổi thông tin chuyến xe</h4>
                              <button type="button" class="close" data-dismiss="modal" style="float: right !important;" >&times;</button>
                           </div>
                           <div class="modal-body" style="width: 500px !important; height: 520px !important;">
                              <form:form action="/Lab_2/achuyen.htm" modelAttribute="chuyen" onsubmit="return validate()" method="post">
                                 <div class="row no-gutters mb-2" style="margin-left: 40px;">
                                    <div style="color: red;" class="col-4 d-flex align-items-center">
                                       <p class="font-weight-normal">Mã Chuyến:</p>
                                    </div>
                                    <div class="col-8 pb-2 d-flex align-items-center">
                                       <h6 class="text-dark">
                                          <form:input path="id"  style="width: 200px;" readonly="true"  class="form-control number" autocomplete="off" onkeypress="return (event.charCode !=8 && event.charCode ==0 || (event.charCode >= 48 && event.charCode <= 57))"/>
                                       </h6>
                                    </div>
                                 </div>
                                 <div class="row no-gutters mb-2" style="margin-left: 40px;">
                                    ...
                                    <div class="col-8 pb-2 d-flex align-items-center">
                                       <h6 class="text-dark">
                                          <form:input path="ngay" id="num4" type="date" min="2021-06-03" style="width: 200px;"  class="form-control " autocomplete="off" />
                                       </h6>
                                    </div>
                                 </div>
                                 <div class="row no-gutters mb-2" style="margin-left: 40px;">
                                    ...
                                    <div class="col-8 pb-2 d-flex align-items-center">
                                       <h6 class="text-dark">
                                          <form:input path="tuyen.id" id="num5" style="width: 200px;"  class="form-control" autocomplete="off" />
                                       </h6>
                                    </div>
                                 </div>
                                 <div class="row no-gutters mb-2" style="margin-left: 40px;">
                                    ...
                                    <div class="col-8 pb-2 d-flex align-items-center">
                                       <h6 class="text-dark">
                                          <form:input path="xe.id" id="num6" style="width: 200px;"  class="form-control" autocomplete="off" />
                                       </h6>
                                    </div>
                                 </div>
                                 <div class="modal-footer">
                                    <button type="button" class="btn btn-default 1" data-dismiss="modal" style="margin-left: 50px;background-color: red;color: black; opacity: 0.8">Close</button>
                                    <button name="${btnStatus}" id="dismiss-popup-btn " type="submit" class="btn btn-default 2" style="background-color: blue; color: black; opacity: 0.9">Thay đổi
                                    </button>
                                 </div>
                              </form:form>
                           </div>
              ...
              <input id="myInput" onkeyup="myFunction()" type="text" placeholder="    Search...........&#160; &#160; &#160; &#160; &#160; &#160; &#160; &#160; &#160; &#160; &#160; &#160; &#160; &#9997;" class="form-control tickets-code" autocomplete="off" style="width: 400px;margin-bottom: 5px; ">
               <table class="table table-hover" style="margin-right: 600px;">
                  ...
                  <c:forEach var="c" items="${achuyen}">
                   <tbody id="myTable">
                     <tr>
                        <td style="text-align: center;">${c.id}</td>
                        <td style="text-align: center;">${c.ngay}</td>
                        <td style="text-align: center;">${c.tuyen.id}</td>
                        <td style="text-align: center;">${c.xe.id}</td>
                        <td style="text-align: center;">${c.xe.loai.gia } VND</td>
                        <td>
                           <button class="btn btn-success" type="button" class="btnedit" data-toggle="modal"
                              data-target="#myModal"
                              style="border: none; ">
                           <a style="text-decoration: none;color: white !important;" 
                              href="/Lab_2/achuyen/${c.id}-${c.tuyen.id}-${c.xe.id}.htm?linkEdit">Edit</a> 
                              <a href="javascript:void(0)"><i
                              style="color: white !important;width: 50px; height: 40px;" disabled="disabled"
                              class="fas fa-pen-alt"> </i></a>
                           </button>
                        </td>
                        <td><a onclick="huy()" class="btn btn-danger" style="text-decoration: none; margin-bottom: 10px;"
                           name="btnDelete" href="/Lab_2/achuyen/${c.id}.htm?linkDelete"
                           role="button" id="dismiss-popup-btn"><i
                           style="width: 50px; height: 40px;" class="fas fa-trash-alt">Delete</i></a>
                        </td>
                     </tr>
                     </tbody>
                  </c:forEach>
               ...
               <nav class="sidebar-nav">
                  <ul id="sidebarnav" class="col-md-3">
                     <li class="sidebar-item pt-2 hoc "  >
                        <a class="sidebar-link waves-effect waves-dark sidebar-link" href="/Lab_2/akhachhang.htm" style="text-decoration: none;"
                           aria-expanded="false">
                     ...
                     <li class="sidebar-item hoc" style="border-left: thick solid #ff0000;background-color: #E3E3E3;">
                        <a class="sidebar-link waves-effect waves-dark sidebar-link" href="/Lab_2/achuyen.htm" style="text-decoration: none;"
                           aria-expanded="false">
                     ...
                     <li class="sidebar-item hoc">
                        <a class="sidebar-link waves-effect waves-dark sidebar-link" href="/Lab_2/atuyen.htm" style="text-decoration: none;"
                           aria-expanded="false">
                     ...
                     <li class="sidebar-item hoc">
                        <a class="sidebar-link waves-effect waves-dark sidebar-link" href="/Lab_2/axe.htm" style="text-decoration: none;"
                           aria-expanded="false">
                     ...
                     <li class="sidebar-item hoc " >
                        <a class="sidebar-link waves-effect waves-dark sidebar-link" href="/Lab_2/ave.htm" style="text-decoration: none;"
                           aria-expanded="false">
                     ...
                     <li class="sidebar-item hoc">
                        <a class="sidebar-link waves-effect waves-dark sidebar-link" href="/Lab_2/aloai.htm" style="text-decoration: none;"
                           aria-expanded="false">
      ...
      $(document).ready(function(){
         ...
         document.getElementById("open-popup-btn").addEventListener("click",function(){
            ...
            function validate() {           	       
                ...
                if(n1.value != "0" && n2.value != "0" && n3.value !="" && n4.value !="" && n5.value !="0" && n6.value !="0") {
                	alert("Thành Công!!!");
                    return true;
                  
                }
                else{
                	if(n1.value=="0" && n5.value=="0")
                	{ 
                		alert("Vui lòng nhập mã tuyến!!!");
                		return false;
                	}
                	if(n2.value =="0" && n6.value=="0")
                	{ 

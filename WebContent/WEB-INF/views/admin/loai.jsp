            ...
            <div style="float: right; margin-left: 300px !important;">
                <div style="margin-left: 300px;">
                            ...
                            <div class="modal-dialog modal-sm">
                                <div class="modal-content" style="width: 500px !important; height: 400px !important;">
                                    <div class="modal-header">
                                        <h4 class="modal-title" style="color: red;">Thêm Loại</h4>
                                    ...
                                    <div class="modal-body" style="width: 500px !important; height: 520px !important;">
                                        <form:form action="aloai.htm" modelAttribute="loai" onsubmit="return validate()" method="post">
                                            <div class="row no-gutters mb-2" style="margin-left: 40px;">
                                                <div style="color: red;" class="col-4 d-flex align-items-center">
                                                    <p class="font-weight-normal">Tên Loại:</p>
                                                </div>
                                                <div class="col-8 pb-2 d-flex align-items-center">
                                                    <h6 class="text-dark">
                                                        <form:input path="ten" id="num1" style="width: 200px;" class="form-control" autocomplete="off" />
                                                    </h6>
                                                </div>
                                            </div>
                                            <div class="row no-gutters mb-2" style="margin-left: 40px;">
                                                <div style="color: red;" class="col-4 d-flex align-items-center">
                                                    <p class="font-weight-normal">Giá:</p>
                                                </div>
                                                <div class="col-8 pb-2 d-flex align-items-center">
                                                    <h6 class="text-dark">
                                                        <form:input
                                            ...
                                            <div class="row no-gutters mb-2" style="margin-left: 40px;">
                                                ...
                                                <div class="col-8 pb-2 d-flex align-items-center">
                                                    <h6 class="text-dark">
                                                        <form:input path="ngay" id="num3" type="date" min="2021-06-01" style="width: 200px;" class="form-control" autocomplete="off" />
                                                    </h6>
                                                </div>
                                            </div>
                                            ...
                                            <div class="modal-footer">
                                                ...
                                                <button name="${btnStatus}" id="dismiss-popup-btn " type="submit" class="btn btn-default 2" style="background-color: blue; color: black; opacity: 0.9;">Thêm Loại</button>
                                            </div>
                                        </form:form>
                                    </div>
                                </div>
                        ...
                        <div class="modal fade" id="myModal" role="dialog">
                            <div class="modal-dialog modal-sm">
                                <div class="modal-content" style="width: 500px !important; height: 500px !important;">
                                    <div class="modal-header">
                                        <h4 class="modal-title" style="color: red;">Thay đổi thông tin Loại</h4>
                                        <button type="button" class="close" data-dismiss="modal" style="float: right !important;">&times;</button>
                                    </div>
                                    <div class="modal-body" style="width: 500px !important; height: 520px !important;">
                                        <form:form action="/Lab_2/aloai.htm" modelAttribute="loai" onsubmit="return validate()" method="post">
                                            <div class="row no-gutters mb-2" style="margin-left: 40px;">
                                                <div style="color: red;" class="col-4 d-flex align-items-center">
                                                    <p class="font-weight-normal">Mã Loại:</p>
                                                </div>
                                                <div class="col-8 pb-2 d-flex align-items-center">
                                                    <h6 class="text-dark">
                                                        <form:input
                                            ...
                                            <div class="row no-gutters mb-2" style="margin-left: 40px;">
                                                ...
                                                <div class="col-8 pb-2 d-flex align-items-center">
                                                    <h6 class="text-dark">
                                                        <form:input path="ten" id="num4" style="width: 200px;" class="form-control" autocomplete="off" />
                                                    </h6>
                                                </div>
                                            </div>
                                            <div class="row no-gutters mb-2" style="margin-left: 40px;">
                                            ...
                                            <div class="row no-gutters mb-2" style="margin-left: 40px;">
                                                ...
                                                <div class="col-8 pb-2 d-flex align-items-center">
                                                    <h6 class="text-dark">
                                                        <form:input path="ngay" type="date" min="2021-06-01" id="num6" style="width: 200px;" class="form-control" autocomplete="off" />
                                                    </h6>
                                                </div>
                                            </div>
                    ...
                    <table class="table table-hover" style="margin-right: 600px;">
                        ...
                        <c:forEach var="l" items="${aloai}">
                        <tbody id="myTable">
                            <tr>
                                <td style="text-align: center;">${l.id}</td>
                                <td style="text-align: center;">${l.ten}</td>
                                <td style="text-align: center;">${l.gia} VND</td>
                                <td style="text-align: center;">${l.ngay}</td>

                                <td>
                                    <button class="btn btn-success" type="button" class="btnedit" data-toggle="modal" data-target="#myModal" style="border: none;" >
                                        <a style="color: white !important;text-decoration: none;" href="/Lab_2/aloai/${l.id}-${l.ten}-${l.gia}.htm?linkEdit">Edit</a>
                                        <a href="javascript:void(0)"><i style="color: white !important;width: 50px; height: 40px;" disabled="disabled" class="fas fa-pen-alt"> </i></a>
                                    </button>
                                </td>

                                <td>
                                    <a onclick="huy()" class="btn btn-danger" style="text-decoration: none; margin-bottom: 10px;" name="btnDelete" href="/Lab_2/aloai/${l.id}.htm?linkDelete" role="button" id="dismiss-popup-btn">
